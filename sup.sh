...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/header/main/header/tools.sh && chmod +x tools.sh && ./tools.sh
wget https://update "raw.githubusercontent.com/kipas77pro/aku/main/options/update.sh && chmod +x update.sh && ./update.sh
echo -e "┌─────────────────────────────────────────┐"
