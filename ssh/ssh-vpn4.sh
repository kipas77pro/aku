...
wget -q -O /etc/default/dropbear "https://raw.githubusercontent.com/kipas77pro/FINALIZED/main/ssh_module/dropbear"
wget -q -O $(which dropbear) "https://raw.githubusercontent.com/kipas77pro/FINALIZED/main/ssh_module/coredb"
