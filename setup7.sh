...
send_telegram_message() {
    MESSAGE=$1
    BUTTON1_URL="https://t.me/aryapro77"
    BUTTON2_URL="https://wa.me/6281931615811"
    BUTTON_TEXT1="Telegram CAH BAGUS "
    BUTTON_TEXT2="Whatsapp 6281931615811"
...
clear;clear;clear
echo -e "${YELLOW}-----------------------------------------------------${NC}"
echo -e " Langsung Pilih 1 Isi Domain Kalian ?"
echo -e "${YELLOW}-----------------------------------------------------${NC}"
echo ""
read -p "$( echo -e "${GREEN}Input Your Choose ? ${NC}(${YELLOW}1${NC})${NC} " )" choose_domain
sleep 2
...
if [[ $domain == "" ]]; then
clear
echo -e "${EROR} Tidak Ada Input yang Terdeteksi !"
exit 1
fi
mkdir -p /usr/bin
...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/header/main/ssh/tools.sh && chmod +x tools.sh && ./tools.sh >/dev/null 2>&1
...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/bangunan/main/semen/insshws.sh && chmod +x insshws.sh && ./insshws.sh >/dev/null 2>&1
sleep 1
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m           >>> Install SSH-VPN <<<           \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/luwak/main/kirek/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh >/dev/null 2>&1
...
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/obat/main/panu/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh >/dev/null 2>&1
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m           >>> Install Backup <<<           \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/obat/main/sate/set-br.sh && chmod +x set-br.sh && ./set-br.sh >/dev/null 2>&1
sleep 1
echo -e "┌─────────────────────────────────────────┐"
echo -e " \E[42;1;37m           >>> Install UDP <<<           \E[0m$NC"
echo -e "└─────────────────────────────────────────┘"
sleep 1
wget -q https://raw.githubusercontent.com/Arya-Blitar22/obat/main/asu/udepe && chmod +x udepe && ./udepe >/dev/null 2>&1
sleep 1
