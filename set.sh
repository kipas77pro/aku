...
echo -e "${GREEN}Upload By Arya Blitar Jatim${NC}"
...
print_install "Menginstall ePro WebSocket Proxy"
    wget -O /usr/bin/ws "https://raw.githubusercontent.com/kipas77pro/aku/main/websocket_engine/install-ws.sh" >/dev/null 2>&1
