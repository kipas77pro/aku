...
res1() {
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/header/refs/heads/main/header/tools.sh -O tools.sh
    chmod +x tools.sh
    ./tools.sh
}
...
res3() {
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/bangunan/refs/heads/main/semen/insshws.sh -O insshws.sh
    chmod +x insshws.sh
    ./insshws.sh
    clear
...
res4() {
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/luwak/refs/heads/main/kirek/ssh-vpn.sh -O ssh-vpn.sh
    chmod +x ssh-vpn.sh
    ./ssh-vpn.sh
...
res5() {
    echo -e "${green}    Install Vray...${NC}"
    wget https://raw.githubusercontent.com/Arya-Blitar22/obat/refs/heads/main/panu/ins-xray.sh -O ins-xray.sh
    chmod +x ins-xray.sh
...
res6() {
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/obat/refs/heads/main/sate/set-br.sh -O set-br.sh
    chmod +x set-br.sh
    ./set-br.sh
    clear
}
...
res7() {
    ...
    wget https://raw.githubusercontent.com/Arya-Blitar22/obat/refs/heads/main/asu/udepe -O udepe
    chmod +x udepe
    ./udepe
    clear
}
